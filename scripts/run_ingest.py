...
print(f"\nsolarWind keys: {fetch_solarWind[0].keys() if fetch_solarWind else 'No data'}")
print(f"Sample solarWind: {fetch_solarWind[0] if fetch_solarWind else 'No data'}")

print(f"\nmag keys: {fetch_mag[0].keys() if fetch_mag else 'No data'}")
print(f"Sample mag: {fetch_mag[0] if fetch_mag else 'No data'}")

print(f"\nkp keys: {fetch_kp[0].keys() if fetch_kp else 'No data'}")
